...
M.formatters = {
	...
	json = "oxfmt --stdin-filepath %",
	jsonc = "oxfmt --stdin-filepath %",
	html = "oxfmt --stdin-filepath %",
	css = "oxfmt --stdin-filepath %",
	scss = "oxfmt --stdin-filepath %",
	markdown = "oxfmt --stdin-filepath %",
	yaml = "oxfmt --stdin-filepath %",
	toml = "oxfmt --stdin-filepath %",
}
